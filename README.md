...
This project is built in chunks, each adding new functionality. **Chunk 1** provides the core 1RM calculation functionality. **Chunk 2** extends it with structured data collection. **Chunk 3** adds weekly analysis of training sessions. **Chunk 4** adds bodyweight tracking and relative strength analysis. **Chunk 5** adds fatigue and recovery tracking with adjusted 1RM calculations.
